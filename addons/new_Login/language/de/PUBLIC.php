...
//Site Screenshots by wumix

$LNG['siteScreenLogo']				= 'Game Screenshots';
$LNG['siteScreen1']			= 'Übersicht';
$LNG['siteScreen1Info']			= 'Alles wichtige auf einen Blick';
$LNG['siteScreen2']			= 'Baumenü';
$LNG['siteScreen2Info']			= 'Hier baust Du deine Planeten aus.';
$LNG['siteScreen3']				= 'Forschungslabor';
$LNG['siteScreen3Info']				= 'Entwickle neue Techniken';
$LNG['siteScreen4']			= 'Schiffswerft';
$LNG['siteScreen4Info']		= 'Transportiere, Führe Kriege, besiedel andere Planeten uvm';
$LNG['siteScreen5']			= 'Statistik';
$LNG['siteScreen5Info']		= 'Schau Dir die Rangliste an um zu sehen auf welchem Platz Du bist';
...
$LNG['loginSlogan']					= 'Das retro Space Browsergame';
$LNG['loginText']					= 'Spiele noch Heute';
$LNG['loginText1']					= 'Eine neue Zivilisation';
$LNG['loginText2']					= 'Du Startest mit einer unterentwickelten Welt, und errichtest auf dieser ein Imperium. Gründest Kolonien und verteidigst diese.';
$LNG['loginText3']					= 'Atemberaubende Flexibilität';
$LNG['loginText4']					= 'Erstelle eine wirtschaftliche und militärische Infrastruktur, auf der Suche nach den nächsten größten technologischen Errungenschaften um dein Reich an die Spitze zu bringen.';
$LNG['loginText5']					= 'Wer bist du?';
$LNG['loginText6']					= 'Bist du der der sein Umfeld terrorisieren wird? Oder wirst du denen die hilflose angreifen zeigen was Angst ist?';
