<?php /* Smarty version Smarty-3.1.13, created on 2017-03-29 13:19:53
         compiled from "/var/www/vhosts/Battlethegalaxy.de/beta.Battlethegalaxy.de/styles/templates/adm/clearcache.tpl" */ ?>
<?php /*%%SmartyHeaderCode:27952345558dbb479bf7175-18653529%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9a0275e6a4952596a0c62485bc603a4ce9a94bb8' => 
    array (
      0 => '/var/www/vhosts/Battlethegalaxy.de/beta.Battlethegalaxy.de/styles/templates/adm/clearcache.tpl',
      1 => 1490793062,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '27952345558dbb479bf7175-18653529',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58dbb479e5f315_85627504',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58dbb479e5f315_85627504')) {function content_58dbb479e5f315_85627504($_smarty_tpl) {?><?php /*  Call merged included template "overall_header.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("overall_header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0, '27952345558dbb479bf7175-18653529');
content_58dbb479c0ac99_29662585($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("head_nav.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0, '27952345558dbb479bf7175-18653529');
content_58dbb479cc3728_73414507($_smarty_tpl);
...
<div class="grid_10">
            <div class="box round first grid" >
                <h2>
                   <?php echo $_smarty_tpl->tpl_vars['LNG']->value['cc_cache_clear'];?>
</h2>
              <div class="block">
...
<center>All cache files have been deleted from the server.</center>
...
<?php }} ?><?php /* Smarty version Smarty-3.1.13, created on 2017-03-29 13:19:53
         compiled from "/var/www/vhosts/Battlethegalaxy.de/beta.Battlethegalaxy.de/styles/templates/adm/overall_header.tpl" */ ?>
<?php if ($_valid && !is_callable('content_58dbb479c0ac99_29662585')) {function content_58dbb479c0ac99_29662585($_smarty_tpl) {?><!DOCTYPE html>

<!--[if lt IE 7 ]> <html lang="<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
" class="no-js ie6"> <![endif]-->
<!--[if IE 7 ]>    <html lang="<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
" class="no-js ie7"> <![endif]-->
<!--[if IE 8 ]>    <html lang="<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
" class="no-js ie8"> <![endif]-->
<!--[if IE 9 ]>    <html lang="<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
" class="no-js ie9"> <![endif]-->
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
" class="no-js"> <!--<![endif]-->
<head>
	...
	var ServerTimezoneOffset = <?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'Offset\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
;
	var serverTime 	= new Date(<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'date\']->value[0];?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
, <?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'date\']->value[1]-1;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
, <?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'date\']->value[2];?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
, <?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'date\']->value[3];?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
, <?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'date\']->value[4];?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
, <?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'date\']->value[5];?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
);
...
";
	var Skin		= "<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'dpath\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
";
	var Lang		= "<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
";
...
";
	...
	<script type="text/javascript" src="./scripts/base/jquery.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<script type="text/javascript" src="./scripts/base/jquery.ui.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<script type="text/javascript" src="./scripts/base/jquery.cookie.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<script type="text/javascript" src="./scripts/base/jquery.fancybox.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<script type="text/javascript" src="./scripts/base/jquery.validationEngine.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<script type="text/javascript" src="./scripts/l18n/validationEngine/jquery.validationEngine-<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<script type="text/javascript" src="./scripts/base/tooltip.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<script type="text/javascript" src="./scripts/game/base.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php  $_smarty_tpl->tpl_vars[\'scriptname\'] = new Smarty_Variable; $_smarty_tpl->tpl_vars[\'scriptname\']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars[\'scripts\']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, \'array\');}
foreach ($_from as $_smarty_tpl->tpl_vars[\'scriptname\']->key => $_smarty_tpl->tpl_vars[\'scriptname\']->value){
$_smarty_tpl->tpl_vars[\'scriptname\']->_loop = true;
?>/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>

	<script type="text/javascript" src="./scripts/game/<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'scriptname\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
.js?v=<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'REV\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
"></script>
	<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php } ?>/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>

	<script type="text/javascript">
	$(function() {
		<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'execscript\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
...
" class="<?php echo '/*%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/<?php echo $_smarty_tpl->tpl_vars[\'bodyclass\']->value;?>
/*/%%SmartyNocache:27952345558dbb479bf7175-18653529%%*/';?>
">
	<div id="tooltip" class="tip"></div><?php }} ?><?php /* Smarty version Smarty-3.1.13, created on 2017-03-29 13:19:53
         compiled from "/var/www/vhosts/Battlethegalaxy.de/beta.Battlethegalaxy.de/styles/templates/adm/head_nav.tpl" */ ?>
<?php if ($_valid && !is_callable('content_58dbb479cc3728_73414507')) {function content_58dbb479cc3728_73414507($_smarty_tpl) {?>
