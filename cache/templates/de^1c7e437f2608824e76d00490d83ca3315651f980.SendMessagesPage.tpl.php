...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_58dbb4806a2ff1_33264867',
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58dbb4806a2ff1_33264867')) {function content_58dbb4806a2ff1_33264867($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_function_html_options')) include '/var/www/vhosts/Battlethegalaxy.de/beta.Battlethegalaxy.de/includes/libs/Smarty/plugins/function.html_options.php';
?><!DOCTYPE html>
...
<table class="table569">
		<tr>
            <th colspan="2">Sende Globale Nachrichten</th>
        </tr>
        <tr>
            <td>Versand als</td>
        ...
        <tr>
            <td>Betreff</td>
            <td><input name="subject" id="subject" size="40" maxlength="40" value="Globale Nachrichten" type="text"></td>
        </tr>
		<tr>
            <td>Nachricht (<span id="cntChars">0</span> / 5000 Zeichen)</td>
            <td><textarea name="text" id="text" cols="40" rows="10" onkeyup="$('#cntChars').text($('#text').val().length);"></textarea></td>
        </tr>
        <tr>
            <td colspan="2"><input type="button" onclick="check();" value="Senden"></td>
        </tr>
    </table>
</form>
 	</div>
