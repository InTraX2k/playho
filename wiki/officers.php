...
<html>
   ...
   <div id="scroller" class="b-top" style="display: none;"><span class="b-top-but">To the top</span></div>
	...
	Officers - are the best representatives of the business, which can boost the performance of your empire.
     <br> officers and governor can be reached through the menu on the left - <b> Senate </b>
    <br>
    
   The officer window.
    <script language = "JavaScript">
		var bigsize = "1900"; //Размер большой картинки
    ...
    <div align="center"><img style="border-radius:10px"  height="200" src="html/images/12/1.png" onclick="changeSizeImage1(this)"> </div><p> 
    
  <p> Each officer has his maximum level, reaching it, the officer can not continue to leveled up. All officers are bought for DM. <p>
     Ability of officers: <br />
    <ul>
    <li> increase the production - <strong> Geologist </strong>
    Improving <li> combat characteristics (attack , shields , armor ) - <strong> Admiral </strong>
    <li> Increase energy production - <strong> Engineer </strong>
    <li> Reducing the ships were built - <strong> Technocrat </strong>
    <li> Reducing the research - <strong> Scientist </strong>
    <li> Increase storage capacity and holds of ships - <strong> Guardian </strong>
    <li> Reduced time to build a defense - <strong> defense minister </strong>
    <li> Improving the ability of spying  - <strong> Scout </strong>
     <li>  Maximum available slots - <strong> Command </strong>
     <li>  Ability demolition moon - <strong> Shredder </strong>
    <li> Increase flight speed ships - <strong> General </strong>
    </ul>
    <p>
    <font size="3"> <b>it's important:</b> Officers are bought for DM and can not be reset</font>
