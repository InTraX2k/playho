...
<html>
 ...
 <p>
The game provides the possibility of inviting players to the game with the referral system. <br>
About the essence is that you give a friend a link that you can find in the Ref. System menu:




<div align="center"><img style="border-radius:10px"   src="html/images/19/1.png" > </div><p> 
Friend registers on the project with this link and you will be credited. You can see it there, where the link is. Once your referral reaches 25,000 points in the statistics, you will receive a bonus of 500,000 Dark Matter and Antimatter 10,000. <p>
Recently, whe have added a referral banners that you can place on other sites. This banner redirect to the main page of the game. Banners, as well as regular link contain your unique ID, for which it will enroll you of a referral. <p>
http://astro-mania.com/index.php?ref=<font color="#009900"><b>657</b></font> -  <p>
Here is a window with a list of your referrals: <br />
<div align="center"><img style="border-radius:10px"   src="html/images/19/2.png" > </div><p> 
